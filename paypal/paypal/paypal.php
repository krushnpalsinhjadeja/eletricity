...
switch($action){
	/*case "process": // case process insert the form data in DB and process to the paypal
		mysql_query("INSERT INTO `purchases` VALUES ('".$_POST["invoice"]."', '".$_POST["product_id"]."', '".$_POST["product_name"]."', '".$_POST["product_quantity"]."', '".$_POST["product_amount"]."', '".$_POST["payer_fname"]."', '".$_POST["payer_lname"]."', '".$_POST["payer_address"]."', '".$_POST["payer_city"]."', '".$_POST["payer_state"]."', '".$_POST["payer_zip"]."', '".$_POST["payer_country"]."', '".$_POST["payer_email"]."', 'pending', NOW())");
...
';		echo '<div class="as_wrapper">';
    ...
    case "process": // case process insert the form data in DB and process to the paypal
		mysql_query("INSERT INTO `purchases` VALUES ('".$_POST["invoice"]."', '".$_POST["pid"]."', '".$_POST["pname"]."', '".$_POST["pquantity"]."', '".$_POST["product_amount"]."', '".$_POST["payer_fname"]."', '".$_POST["payer_lname"]."', '".$_POST["payer_address"]."', '".$_POST["payer_city"]."', '".$_POST["payer_state"]."', '".$_POST["payer_zip"]."', '".$_POST["payer_country"]."', '".$_POST["payer_email"]."', 'pending', NOW())");
		$this_script = 'http://'.$_SERVER['HTTP_HOST'].$_SERVER['PHP_SELF'];
        $homepageurl='http://localhost/eletricity/homepage.php';
		$p->add_field('business', 'rknakum07@gmail.com'); // Call the facilitator eaccount
		$p->add_field('cmd', $_POST["cmd"]); // cmd should be _cart for cart checkout
